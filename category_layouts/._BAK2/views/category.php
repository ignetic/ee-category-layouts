...
function display_field_type($field)
{
	...
	switch ($field['field_type']) {
		case 'text':
			...
			break;
		case 'textarea':
			$field_display = form_dropdown('cl_textarea', array('textarea' => 'Textarea', 'editor' => 'Rich Text Editor'), $selected); //form_textarea('cl_textarea', 'Textarea', 'disabled');
			break;
		case 'select':
	...
	<div class="form-standard">
		...
		<fieldset>
			...
			<div class="field-control">
				<?= form_dropdown('settings[cat_editor]', $cat_editor_select, $cat_editor); ?>
			</div>
		</fieldset>
