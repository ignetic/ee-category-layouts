...
if ( ! defined('CATEGORY_LAYOUTS_NAME'))
{
	define('CATEGORY_LAYOUTS_AUTHOR_URL',	'https://github.com/ignetic'); 
	...
	define('CATEGORY_LAYOUTS_VERSION',      '1.4.5');
}

$config['name'] = CATEGORY_LAYOUTS_NAME;
$config['version'] = CATEGORY_LAYOUTS_VERSION;
